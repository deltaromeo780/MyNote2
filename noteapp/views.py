...
# from .forms import TagForm, NoteForm, Tag
...
#
# # def main(request):
# #     return render(request, 'noteapp/index.html')  # 6
#
# def main(request):
#     notes = Note.objects.all()
#     return render(request, 'noteapp/index.html', {"notes": notes})  # 16
...
#
#     return render(request, 'noteapp/tag.html', {'form': TagForm()})   # 10
...
# def set_done(request, note_id):   # 17
#     Note.objects.filter(pk=note_id).update(done=True)
#     return redirect(to='noteapp:main')
#
#
# def delete_note(request, note_id):  # 18
